import { normalizeTenantAuthBaseUrl as normalizeAuthBaseUrlCore } from "@xkova/sdk-core";
/**
 ...
 */
export const normalizeTenantAuthBaseUrl = (authDomain) => {
    const protocol = typeof window !== "undefined" && (window.location?.protocol ?? "").length > 0
        ? window.location.protocol
        : undefined;
    return normalizeAuthBaseUrlCore(authDomain, { defaultProtocol: protocol });
};
