...
export const useTenantConfig = () => {
    ...
    bootstrap?.tenant?.transferProviders ??
        bootstrap?.tenant?.transfer_providers ??
        bootstrap?.transferProviders ??
        bootstrap?.transfer_providers ??
        // state (camel + snake)
        state.tenant?.transferProviders ??
        state.tenant?.transfer_providers ??
...
export const useAccountState = () => {
    ...
    const [accountState, setAccountState] = useState(state.accountState ?? null);
    const [isLoading, setIsLoading] = useState(false);
    const [error, setError] = useState(null);
    useEffect(() => {
