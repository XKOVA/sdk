 ...
 */
export declare const ensureFreshTokenWithDedupe: ({ force, current, inFlight, fetchTokens, setCurrent, setInFlight, refreshSkewSeconds, }: EnsureFreshTokenWithDedupeParams) => Promise<TokenSet | null>;
