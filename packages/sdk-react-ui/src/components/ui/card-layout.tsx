 ...
 * - None.
 */
export function CardHeaderRow({ title, description, actions, className, ...props }: CardHeaderRowProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      {actions ? <div className="shrink-0 max-w-full justify-self-end">{actions}</div> : null}
    </div>
  );
}
 ...
 * - None.
 */
export function CardSectionLabel({ as = "div", className, ...props }: CardSectionLabelProps) {
  const Comp = as;
  return <Comp className={cn("text-xs text-muted-foreground uppercase tracking-wide", className)} {...props} />;
}
 ...
 * - None.
 */
export function CardEmptyState({ className, ...props }: CardEmptyStateProps) {
  return <div className={cn("text-sm text-muted-foreground py-4 text-center", className)} {...props} />;
}
 ...
 * - None.
 */
export function CardValue({ variant = "primary", className, ...props }: CardValueProps) {
  return (
    <div
      className={cn(
        variant === "primary" ? "text-3xl font-semibold tracking-tight" : "text-sm font-medium",
        className,
      )}
      {...props}
    />
