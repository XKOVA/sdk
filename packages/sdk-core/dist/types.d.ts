 ...
 * @see /api/v1/transfers/transactions
 */
export type TransferTransactionStatus = 'pending' | 'processing' | 'completed' | 'failed' | 'cancelled' | 'expired';
/**
 ...
 * @see /api/v1/transfers/transactions
 */
export type TransferPaymentMethod = 'credit_card' | 'debit_card' | 'bank_transfer' | 'sepa' | 'ach' | 'wire_transfer' | 'apple_pay' | 'google_pay' | 'account';
/**
 ...
 */
export type TransactionStatus = 'queued' | 'submitted' | 'pending' | 'success' | 'mined' | 'failed' | 'cancelled' | 'unknown';
/**
 ...
 * - `/api/v1/transactions/history` (apps/api).
 */
export type TransactionEventType = 'token_transfer' | 'nft_transfer' | 'contract_interaction' | 'account_deployment';
/**
 ...
 * - `/api/v1/transactions/history` (apps/api).
 */
export type TransactionExecutionMethod = 'user_operation' | 'direct' | 'relayed' | null;
/**
 ...
 */
export type TransactionCategory = 'transfer' | 'p2p' | 'escrow' | 'agent' | 'other';
/**
 ...
 * - `/api/v1/transactions/history` (apps/api).
 */
export type TransactionStatusCanonical = 'queued' | 'pending' | 'success' | 'failed' | 'unknown';
/**
 ...
 * - Type alias only; no runtime behavior.
 */
export type TransactionProvenance = 'known_flow' | 'indexer' | 'external' | 'unknown';
/**
 ...
 * - Type alias only; no runtime behavior.
 */
export type TransactionImageSource = 'ramp_provider' | 'agent_icon' | 'counterparty_avatar' | 'network_logo' | 'fallback';
/**
 ...
 */
export type TransactionCounterpartyType = 'agent' | 'user' | 'external' | 'ramp_provider' | 'system' | 'unknown';
/**
...
export interface TransactionHistoryItem {
    ...
    assetType: 'native' | 'token' | 'nft' | 'mixed' | 'contract' | 'deployment' | 'other';
 ...
 */
export type AgentCategory = 'payments' | 'commerce' | 'analytics' | 'ops' | 'tooling' | 'misc';
/**
