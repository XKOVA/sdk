 ...
 * @advanced
 */
export const fetchBootstrapWithAccessToken = async (accessToken, options) => {
    if (!accessToken) {
 ...
 * @advanced
 */
export const createAccessTokenVerifier = (options) => async (accessToken) => fetchBootstrapWithAccessToken(accessToken, options);
