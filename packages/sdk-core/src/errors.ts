...
export class TimeoutError extends SDKError {
  constructor(message = "Request timed out", details?: unknown, meta?: SDKErrorMeta) {
...
export class AbortedError extends SDKError {
  constructor(message = "Request aborted", details?: unknown, meta?: SDKErrorMeta) {
...
export class UnauthorizedError extends SDKError {
  constructor(message = "Authentication required", status?: number, details?: unknown, meta?: SDKErrorMeta) {
...
export class NotFoundError extends SDKError {
  constructor(message = "Not found", status?: number, details?: unknown, meta?: SDKErrorMeta) {
...
export class RateLimitedError extends SDKError {
  constructor(message = "Rate limited", status?: number, details?: unknown, meta?: SDKErrorMeta) {
...
export class ServerError extends SDKError {
  constructor(message = "Server error", status?: number, details?: unknown, meta?: SDKErrorMeta) {
...
export class BadResponseError extends SDKError {
  constructor(message = "Invalid response", status?: number, details?: unknown, meta?: SDKErrorMeta) {
